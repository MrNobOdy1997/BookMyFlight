...
import 'package:bookmyflight/Widgets/thick_container.dart';
import 'package:bookmyflight/Widgets/ticket_screen_column.dart';
                      ...
                      Expanded(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child:const CustomDivider(sections: 6),
                          ),
                          Center(
              ...
              child: Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      TicketScreenColumn(firstText: ticket['date'], secondText: "Date", alignmentType:  CrossAxisAlignment.start,isColor:isColor),
                      TicketScreenColumn(firstText: ticket['departure_time'], secondText:  "Departure Time", alignmentType:  CrossAxisAlignment.center,isColor:isColor),
                      TicketScreenColumn(firstText:  ticket['number'], secondText:  "Number", alignmentType:  CrossAxisAlignment.end,isColor:isColor),
                    ],
                  )
                ],
              ),
